...
_INSTRUCTION = (
    ...
    "research-notes/bus/memory/best-practices.user.md, then judge ONLY whether "
    "the response satisfies the request. Be adversarial: flag claims asserted "
    "as fact but not verified against code/data/a cited source, overreach, and "
    "guidance violations. It may read files / grep to check claims. Return "
